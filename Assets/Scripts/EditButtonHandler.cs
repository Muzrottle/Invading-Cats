...
public class EditButtonHandler : MonoBehaviour
{
    ...
    [Header("Button Backgrounds")]
    [SerializeField] EditButton pressedButton;
    ...
    //void AssignPressedButton(EditButton editButton)
    //{
    //    pressedButton.isPressed = !pressedButton.isPressed;
    //    ButtonChangeBackground(pressedButton.button, pressedButton.isHovered, pressedButton.isPressed);
    ...
    //public void DisplayName(EditButton pressedButton)
    //{
    //    int index = 0;

    //    if (editButtons.Contains(pressedButton))
    //    {
    //        index = editButtons.IndexOf(pressedButton);
    //        Debug.Log(editButtons[index].name);
